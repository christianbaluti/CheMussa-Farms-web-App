...
$name = $conn->real_escape_string($_POST['name2222']);
$id = $conn->real_escape_string($_POST['id2222']);
$main_text = $conn->real_escape_string($_POST['main_text2222']);

// Use a prepared statement to update the table
$sql = "UPDATE service_service_page_3
        SET name = ?, main_text = ?
        WHERE id = ?";
