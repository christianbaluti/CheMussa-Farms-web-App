...
$name = $conn->real_escape_string($_POST['name222']);
$id = $conn->real_escape_string($_POST['id222']);
$main_text = $conn->real_escape_string($_POST['main_text222']);

// Use a prepared statement to update the table
$sql = "UPDATE home_3_paragraphs
        SET name = ?, main_text = ?
        WHERE id = ?";
