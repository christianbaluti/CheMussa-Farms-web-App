            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="blog.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bookshelf" style="padding-right: 0px;margin-right: 19px;">
                            ...
                            </svg><span>Gallery</span></a><a class="nav-link active" href="events.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-plus-slash-minus" style="margin-right: 18px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">New event</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <form id="eventForm" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label class="form-label" for="eventName"><strong>Event Name</strong></label>
                                            <input class="form-control" type="text" id="eventName" name="eventName" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="eventField"><strong>Field</strong></label>
                                            <input class="form-control" type="text" id="eventField" name="eventField" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="eventDetails"><strong>Event Details</strong></label>
                                            <textarea class="form-control" id="eventDetails" name="eventDetails" required></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="eventImage1"><strong>Event Image 1</strong></label>
                                            <input class="form-control" type="file" id="eventImage1" name="eventImage1" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="eventImage2"><strong>Event Image 2</strong></label>
                                            <input class="form-control" type="file" id="eventImage2" name="eventImage2">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="eventImage3"><strong>Event Image 3</strong></label>
                                            <input class="form-control" type="file" id="eventImage3" name="eventImage3">
                                        </div>
                                        <div class="mb-3">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Events made</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="eventsTable">
                                    <thead>
                                        <tr>
                                            <th>Image</th>
                                            <th>Name</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/10.16.7/sweetalert2.min.js"></script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/10.16.7/sweetalert2.min.js"></script>
<script>
    $(document).ready(function() {
        ...
        $('#eventForm').on('submit', function(event) {
            ...
            $.ajax({
                ...
                error: function() {
                    Swal.fire('Error', 'Could not add event', 'error');
                }
            });
        });
        ...
        // Edit event (open form with existing data)
        $(document).on('click', '.btn-edit', function() {
            var eventId = $(this).data('id');
            $.ajax({
                url: 'events.backend.php',
                type: 'GET',
                data: {id: eventId, action: 'get'},
                success: function(data) {
                    var event = JSON.parse(data);
                    $('#eventName').val(event.name);
                    $('#eventField').val(event.field);
                    $('#eventDetails').val(event.main_text);
                    $('#eventForm').append('<input type="hidden" name="id" value="' + eventId + '">');
                    $('#eventForm').append('<input type="hidden" name="action" value="update">');
                    $('#eventForm button').text('Update');
                }
            });
        });
    });
